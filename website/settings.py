...
JAZZMIN_SETTINGS = {
    ...
    "topmenu_links": [
        {"name": "Home", "url": "/", "permissions": ["auth.view_user"]},
        {
            ...
            "url": "/gallery/upload",
            "permissions": ["auth.view_user", "is_superuser"],
        },
        {
            "name": "Gallery News Upload",
            "url": "/gallery/upload_news",
            "permissions": ["auth.view_user", "is_superuser"],
        },
        {
            "name": "Download Data in Excel",
            "url": "/forms/download",
            "permissions": ["auth.view_user", "is_superuser"],
        },
    ],
...
PARENT_FOLDER_ID_PROFILE = os.getenv("PARENT_FOLDER_ID_PROFILE")
